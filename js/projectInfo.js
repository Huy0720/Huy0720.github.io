const Projects = {
    Details: {//adding in opposite-chronological order, so it's easy to add later    
        ...
        FragmentedMind: {
            ...
            LargeDescription: 
            'Schizophrenia is a serious mental illness that is characterized by symptoms such as delusions, hallucinations, disorganized thinking, and abnormal behaviors. Despite its prevalence, schizophrenia remains a highly stigmatized and misunderstood condition, which often leads to misconceptions and discrimination towards people who suffer from it. Our game aims to provide a unique perspective on schizophrenia by allowing players to experience firsthand what it is like to live with the disorder.<br>Collaborating closely with artists, audio engineers, and a dedicated scriptwriter, our team orchestrated the development of an immersive first-person simulation, accompanied by a narrative spanning four locations that aims to offered players a poignant glimpse into the daily struggles associated with the disorder.<br>As the game designer, I meticulously translated the research and collective insights into tangible gameplay mechanics that would effectively simulate the cognitive and perceptual distortions characteristic of schizophrenia. This required a deep understanding of both game design principles and the nuances of mental health, ensuring a respectful and accurate representation.',
            DownloadLink: "",
